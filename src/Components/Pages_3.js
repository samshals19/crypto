            ...
            <div className="container">
              <div>
                ...
                <div className="section_one_right">
                  <ul>
                    <li>
                      <span className="first">0 Hives</span>
                    </li>
                    <li>
                      <span className="first">O.OOOOO Polymatic</span>
                    </li>
                    <li>
                      <span className="first">O.OOOOO Polymatic</span>
                    </li>
                    <li>
                      <span className="blank ">sdfmdlfmlf</span>
                    </li>
                    <li>
                      <span className="first">0.0 Polymatic</span>
                    </li>
                  </ul>
                </div>
              </div>
